...
CREATE TABLE `potential_vulnerability_table` (
                                                 ...
                                                 CONSTRAINT fk_project_issue FOREIGN KEY (`project_name`) REFERENCES `project_table` (`project_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `asset_table` (
                               ...
                               CONSTRAINT fk_project_asset FOREIGN KEY (`project_name`) REFERENCES `project_table` (`project_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `annotation_table` (
                                    ...
                                    `annotation_hash` varchar(64) NOT NULL,
                                    `project_name` varchar(256) NOT NULL,
                                    `replaces_name` varchar(256),
                                    `replaces_id` varchar(36),
                                    `replaces_hash` varchar(64),
                                    `filepath` varchar(256) NOT NULL,
                                    `annotation_startcomment_startposition_offset` int NOT NULL,
                                    `annotation_startcomment_startposition_linenumber` int NOT NULL,
                                    `annotation_startcomment_startposition_column` int NOT NULL,
                                    `annotation_startcomment_endposition_offset` int NOT NULL,
                                    `annotation_startcomment_endposition_linenumber` int NOT NULL,
                                    `annotation_startcomment_endposition_column` int NOT NULL,
                                    `annotation_endcomment_startposition_offset` int,
                                    `annotation_endcomment_startposition_linenumber` int,
                                    `annotation_endcomment_startposition_column` int,
                                    `annotation_endcomment_endposition_offset` int,
                                    `annotation_endcomment_endposition_linenumber` int,
                                    `annotation_endcomment_endposition_column` int,
                                    `annotation_codeblock_startposition_offset` int NOT NULL,
                                    `annotation_codeblock_startposition_linenumber` int NOT NULL,
                                    `annotation_codeblock_startposition_column` int NOT NULL,
                                    `annotation_codeblock_endposition_offset` int NOT NULL,
                                    `annotation_codeblock_endposition_linenumber` int NOT NULL,
                                    `annotation_codeblock_endposition_column` int NOT NULL,
                                    `created_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                                    ...
                                    CONSTRAINT fk_project_annotation FOREIGN KEY (`project_name`) REFERENCES `project_table` (`project_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
